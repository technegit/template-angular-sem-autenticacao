...
@Table(name = "\"grupo\"")
@NamedQueries({
        @NamedQuery(name = "grupoList", query = "select g from Grupo g"),
        @NamedQuery(name = "grupoListByNome", query = "select g from Grupo g where g.nome LIKE CONCAT('%', COALESCE(:nome, g.nome),'%')")
})
@XmlRootElement
