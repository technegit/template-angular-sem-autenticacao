...
/**
 * Classe que representa a camada de negócios de Grupo
 * @generated
 **/
public class GrupoBusiness {

  /**
   * Instância da classe GrupoDAO que faz o acesso ao banco de dados
   * @generated
   */
   ...
   */
  public GrupoBusiness(final SessionManager sessionmanager) {
    // begin-user-code
    // end-user-code
    this.sessionManager = sessionmanager;
    this.dao = new GrupoDAO(sessionmanager.getEntityManager());
    // begin-user-code
    // end-user-code
  }
   ...
   * @generated modifiable   
   */
  public void save(final Grupo entity) {
    // begin-user-code
    // end-user-code  
    dao.save(entity);
    // begin-user-code
   ...
   * @generated modifiable
   */
  public void refresh(final Grupo entity) {
    // begin-user-code
    // end-user-code  
    dao.refresh(entity);
    // begin-user-code
   ...
   * @generated modifiable   
   */
  public Grupo update(final Grupo entity) {
    // begin-user-code
    // end-user-code  
	Grupo updatedEntity = dao.update(entity);
    // begin-user-code
    // end-user-code	
  ...
  public List<Contato> findContato(java.lang.String id, int limit, int offset) {
      // begin-user-code
      // end-user-code  
      List<Contato> result = dao.findContato(id, limit, offset);
      // begin-user-code  
      // end-user-code        
      return result;	  
  }
  ...
  public List<Grupo> list(int limit, int offset){
      // begin-user-code
      // end-user-code  
      List<Grupo> result = dao.list(limit, offset);
      // begin-user-code
      // end-user-code        
      return result;	
  }  
  ...
  public List<Grupo> listByNome(java.lang.String nome, int limit, int offset){
      // begin-user-code
      // end-user-code  
      List<Grupo> result = dao.listByNome(nome, limit, offset);
      // begin-user-code
      // end-user-code        
      return result;	
  }  
